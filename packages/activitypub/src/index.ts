...
export {
  ...
  ACTIVITYPUB_OPERATIONS_SNAPSHOT_WINDOW_HOURS,
  ACTIVITYPUB_ORIGIN_FAILURE_METRICS_EVENT,
  ACTIVITYPUB_ORIGIN_FAILURE_OTHER_LABEL,
  ACTIVITYPUB_ORIGIN_FAILURE_TOP_N,
  ACTIVITYPUB_QUEUE_ADMIN_CHANGE_REF_MAX_LENGTH,
  ACTIVITYPUB_QUEUE_ADMIN_CHANGE_REF_PATTERN,
  ACTIVITYPUB_QUEUE_ADMIN_UTC_TIMESTAMP_PATTERN,
  ACTIVITYPUB_QUEUE_METRICS_EVENT,
  type ActivityPubOperationsSnapshot,
  type ActivityPubOriginFailureSummary,
  type ActivityPubQueueAdminMutationInput,
  type ActivityPubQueueAdminMutationResult,
  type ActivityPubQueueDepthByStatus,
  type ActivityPubQueueInspectView,
  type ActivityPubQueueOperatorAction,
