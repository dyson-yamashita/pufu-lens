...
| `docs/plans/009-oss-deployment-options/overview.md`        | `active`    | 2026-06-26 | Issue #318 で Step 1 完了。Issue #325 で Step 2 の GCP Cloud Build CI example を追加。Step 3 以降の deploy example / operations docs が残作業。        |
