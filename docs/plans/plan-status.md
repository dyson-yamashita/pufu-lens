...
| `docs/plans/009-oss-deployment-options/overview.md`        | `active`    | 2026-06-26 | Issue #318 で Step 1 完了。初期実装は GCP Cloud Build example に限定し、将来の AWS Amplify 等を provider 分離で扱う。                                  |
