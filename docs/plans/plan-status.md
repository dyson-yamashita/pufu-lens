...
| `docs/plans/012-report-metric-sources/overview.md`         | `planned`   | 2026-07-01 | Issue #399 で追加。カスタムレポートに表・グラフ・KPI などの集計パーツを追加し、Data Source と Report Part の間に Metric Source / projection table / declarative metric query を導入する計画。                                                                                                                                                                     |
