...
| `docs/plans/012-public-private-result-parity/overview.md`  | `active`    | 2026-07-04 | Issue #425 で追加。Step 1 として public chat の Mastra request context を private chat と揃え、report は private report JSON / renderer ベースの現行方針を維持する。                                                                                                                                                                                              |
