...
| `docs/plans/013-incremental-source-sync-scheduling/overview.md` | `active` | 2026-07-10 | Issue #512 / PR #513 で Step 1 の logical ID / source version / sync cursor DB model と migration を実装。Step 2 以降で差分取り込み、最新版置換、非 Web 日次 schedule、dispatcher、管理 UI を実装する。 |
