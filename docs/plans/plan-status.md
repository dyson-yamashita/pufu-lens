...
| `docs/plans/006-db-migration-management/overview.md`       | `active`    | 2026-06-12 | Issue #119 で Step 1、Issue #121 で Step 2、Issue #123 で Step 3、Issue #127 で Step 4 完了。Step 5 以降で drift 検出を継続整備する。 |
