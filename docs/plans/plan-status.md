...
| `docs/plans/008-agent-raw-reading/overview.md`             | `active`    | 2026-06-24 | Step 1–3 完了: Agent Raw Read View contract 定義、Parser Profiles 廃止、raw read adapter / repository 境界を実装。Step 4 private chat 統合が次。       |
