...
| `docs/plans/013-incremental-source-sync-scheduling/overview.md` | `active` | 2026-07-10 | Issue #512 で Step 1 着手。logical ID / source version / sync cursor の DB model と migration を追加中。差分取り込み、raw 版履歴、最新版置換、非 Web 日次 schedule、dispatcher、管理 UI を Step 1–5 で実装する。 |
