...
| `docs/plans/004-project-settings-connections/overview.md`  | `active`    | 2026-06-28 | Step 1-6 完了。Step 7 で失効・scope 不足・解除済み connection の運用表示、検証、deploy checklist 更新を実施中。                                                                                                                                                                   |
