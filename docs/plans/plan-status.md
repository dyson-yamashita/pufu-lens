...
| `docs/plans/013-incremental-source-sync-scheduling/overview.md` | `active` | 2026-07-11 | Issue #512 / PR #513 で Step 1、Issue #516 / PR #517 で Step 2 を完了。Issue #514 / PR #515 で local one-shot dispatcher の実行要件を追加。Issue #518 で Step 3 の schedule model、自動作成、backfill、管理 UI に着手。 |
