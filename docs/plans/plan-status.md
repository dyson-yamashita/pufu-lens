...
| `docs/plans/008-agent-raw-reading/overview.md`             | `active`    | 2026-06-24 | Step 1–2 完了: Agent Raw Read View contract 定義、Parser Profiles を通常 admin UI から削除。Step 3 raw read adapter が次。                             |
