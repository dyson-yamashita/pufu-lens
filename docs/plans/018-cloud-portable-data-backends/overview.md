...
| GCP keyword provider         | Step 3D品質補修・切替準備中 | LIKE OR pg_trgm word similarity / GiST候補をshadow比較とportable primary + PGroonga fallbackへ接続。数字境界の14-case holdoutはIssue #763で合格したが、広いholdout・大規模負荷・hybrid品質・本番切替は後続gate（ADR-005） |
