...
| Step 13d | [Mastra Agent / Workflow 登録](step-13d-mastra-agent-workflow.md)                      | `active`    | 2026-06-04 | Issue #55 で Step 12 / 13a の server-side core を Mastra Agent / Workflow として登録する。 |
