...
| Deploy Cloud Build SA  | Artifact Registry writer、Cloud Run / Jobs deploy、Firebase App Hosting deploy、Service Account User、Service Usage Viewer、Browser または custom read role | 環境ごとに分離する                                                              |
