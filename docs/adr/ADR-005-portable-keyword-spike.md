...
Unicode / escapingを含め、`31417`の関連なしnumeric queryがinvoice 2件へ近似一致する不合格を再現・記録する。thresholdやv1
judgmentは緩めない。large / long / project-skewed corpus、自然plannerでのGIN/GiST、WAL / capacity / write amplification / latency
