...
CREATE INDEX graph_edges_project_source_relation_target_idx
  ON public.graph_edges (project_id, source_node_key, relation_type, target_node_key);

CREATE INDEX graph_edges_project_target_relation_source_idx
...
CREATE INDEX document_chunks_keyword_gist_idx
...
VALUES
  ...
  ('0026_relational_graph_schema'),
  ('0027_portable_keyword_schema'),
  ('0028_portable_keyword_index')
