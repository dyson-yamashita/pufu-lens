-- Baseline schema for db:schema-drift.
-- Source: infra/docker/postgres/init.sql at f8dfd99^1, the mainline state before
-- the numbered migration history was merged.
-- This is not a complete from-empty migration history; it is the starting point
-- for replaying infra/db/migrations/*.sql during drift checks.
